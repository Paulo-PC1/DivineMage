...
Fiz toda a documentação inicial, agrupamento das ideias gerais e principais mecânicas, repositório no github, e preparo do ambiente de programação.

## Dia 17/09/2026

Fiz o levantamento de requisitos funcionais e não funcionas do gae e fiz a idealização da estrutura de pastas necessárias para o game.
